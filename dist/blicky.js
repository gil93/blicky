...
/******/ 	var hotCurrentHash = "477a075c8924c90f47b9"; // eslint-disable-line no-unused-vars
...
var core = _interopRequireWildcard(__webpack_require__(2));

var animate = _interopRequireWildcard(__webpack_require__(3));
...
var Blicky = function Blicky(element, options) {
  _classCallCheck(this, Blicky);

  if (!element.length) throw Error('Need to provide element');
  this.element = _typeof(element) == 'object' ? element[0] : document.querySelectorAll(element)[0];
  this.defaults = {};
...
function setDomProps() {
  var slides = Array.from(this.element.children);
...
function build() {
  var markup = createContainer.call(this);
  ...
  this.slider = _extends({}, this.slider, newSliderProps);
}

function createSlides() {
  return this.originalElement.slides.map(function (slide) {
    return "\n\n\t\t\t<div class=\"blicky-slide\">\n\n\t\t\t\t".concat(slide.outerHTML, "\n\n\t\t\t</div>\n\n\t\t");
  }).join(' ');
}

function createContainer() {
  return "\n\n\t\t<div class=\"blicky-wrapper\">\n\n\t\t\t<div class=\"blicky-container\">\n\n\t\t\t\t<div class=\"blicky\">\n\n\t\t\t\t\t".concat(createSlides.call(this), "\n\n\t\t\t\t</div>\n\n\t\t\t</div>\n\n\t\t</div>\n\n\t");
}
...
function animateInit() {
  ...
  slider.container.style.height = "".concat(slider.height, "px");
  slider.blicky.style.width = "".concat(slider.width * slider.slideCount, "px");
  slider.slides.forEach(function (slide) {
    return slide.style.width = "".concat(slider.width, "px");
  });
}
