...
/******/ 	var hotCurrentHash = "e70ecd6bd6094af29018"; // eslint-disable-line no-unused-vars
...
var _Object$assign = __webpack_require__(88);
...
var _from = _interopRequireDefault(__webpack_require__(62));

var _imagesloaded = _interopRequireDefault(__webpack_require__(63));
...
function build() {
  ...
  var domSlides = this.slider.blicky.getElementsByClassName('blicky-slide');
  this.slider.blicky.style.width = "".concat(this.slider.width * domSlides.length, "px");
  (0, _from.default)(domSlides).forEach(function (slide) {
    return slide.style.width = "".concat(_this.slider.width, "px");
  });
  this.slider.blicky.style.left = "".concat(window.parseInt(domSlides[0].dataset.blickyIndex) * this.slider.width, "px");
  this.slider.container.style.height = "".concat(this.slider.height, "px");
}

function rebuild() {
  var _this2 = this;

  new _imagesloaded.default(this.slider.element, function () {
    var newWidth = _this2.slider.element.parentElement.clientWidth;

    var domSlides = _this2.slider.blicky.getElementsByClassName('blicky-slide');

    _this2.slider.blicky.style.width = "".concat(newWidth * _this2.slider.slideCount, "px");
    (0, _from.default)(domSlides).forEach(function (slide) {
      return slide.style.width = "".concat(newWidth, "px");
    });
    _this2.slider.container.style.height = "".concat(domSlides[0].clientHeight, "px");
    _this2.slider.width = _this2.slider.element.clientWidth;
    _this2.slider.posX = _this2.slider.currentSlide * _this2.slider.width * -1;

    _move.move.call(_this2, 0, true);
  });
}
...
function move(cX, resizing) {
  ...
  slider.blicky.style.left = "".concat(slider.posX, "px");
}
...
var _core = _interopRequireDefault(__webpack_require__(106));

var _drag = _interopRequireDefault(__webpack_require__(116));

var _events = _interopRequireDefault(__webpack_require__(120));

var Blicky = function Blicky(element, options) {
  var _this = this;

  (0, _classCallCheck2.default)(this, Blicky);
  var self = this;
  if (!element.length) throw Error('Need to provide element');
  this.element = (0, _typeof2.default)(element) == 'object' ? element[0] : document.querySelectorAll(element)[0];
  this.defaults = {
    infinite: false
  };
  this.options = (0, _extends2.default)({}, this.defaults, options);
    ...
    return _regenerator.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return new _core.default(_this);

          case 2:
            core = _context.sent;
            self = (0, _extends2.default)({}, self, core);
            new _drag.default(self);
            new _events.default(self);
...
var _promise = _interopRequireDefault(__webpack_require__(41));
...
var _publish = __webpack_require__(114);

var _infinite = __webpack_require__(115);

var Core =
/*#__PURE__*/
function () {
  function Core(blicky) {
    var _this = this;
    ...
    _regenerator.default.mark(function _callee() {
      return _regenerator.default.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _this.preBuildOptions();

              _context.next = 3;
              return _this.setDomProps();

            case 3:
              _this.buildSlider();

              _this.postBuildOptions();

              _build.build.call(_this.blicky);

              return _context.abrupt("return", _this.blicky);
  ...
  (0, _createClass2.default)(Core, [{
    key: "preBuildOptions",
    value: function preBuildOptions() {
      var options = this.blicky.options;
    }
  }, {
    key: "postBuildOptions",
    value: function postBuildOptions() {
      var options = this.blicky.options;
      if (options.infinite === true) _infinite.infinite.call(this.blicky);
    }
  }, {
    key: "setDomProps",
    value: function () {
      var _setDomProps = (0, _asyncToGenerator2.default)(
      /*#__PURE__*/
        ...
        return _regenerator.default.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                slides = (0, _from.default)(this.blicky.element.children);
                this.blicky = (0, _extends2.default)({}, this.blicky, {
                  slides: slides,
                  slider: {
                ...
                return new _promise.default(function (resolve, reject) {
                  new _imagesloaded.default(_this2.blicky.element, function (result) {
                    _this2.blicky = (0, _extends2.default)({}, _this2.blicky, {
                      slider: (0, _extends2.default)({}, _this2.blicky.slider, {
                        width: _this2.blicky.element.clientWidth
                      })
                    });
                    resolve(result);
                  });
      ...
      return function setDomProps() {
        return _setDomProps.apply(this, arguments);
      };
    }()
  }, {
    key: "createSlides",
    value: function createSlides() {
      return this.blicky.slides.map(function (slide) {
        return "\n\n\t\t\t\t<div class=\"blicky-slide\">\n\n\t\t\t\t\t".concat(slide.outerHTML, "\n\n\t\t\t\t</div>\n\n\t\t\t");
      }).join(' ');
    }
  }, {
    key: "createContainer",
    value: function createContainer() {
      return "\n\n\t\t\t<div class=\"blicky-wrapper\">\n\n\t\t\t\t<div class=\"blicky-container\">\n\n\t\t\t\t\t<div class=\"blicky\">\n\n\t\t\t\t\t\t".concat(this.createSlides(), "\n\n\t\t\t\t\t</div>\n\n\t\t\t\t</div>\n\n\t\t\t</div>\n\n\t\t");
    }
  }, {
    key: "buildSlider",
    value: function buildSlider() {
      var markup = this.createContainer();
      var newSlider = new DOMParser().parseFromString(markup, 'text/html').body.firstChild;

      _publish.publish.call(this, newSlider);

      var slides = (0, _from.default)(this.blicky.element.getElementsByClassName('blicky-slide')).map(function (slide, index) {
      ...
      this.blicky.slider = (0, _extends2.default)({}, this.blicky.slider, newSliderProps);
    }
  }]);
  return Core;
}();
...
var infiniteSlide = function infiniteSlide(direction, index, slide) {
...
function infinite() {
  ...
  slides.slice(slider.slideCount - 1, slider.slideCount).reverse().forEach(function (slide, index) {
    return slider.blicky.insertBefore(infiniteSlide('left', index, slide), slider.blicky.children[0]);
  });
  slides.slice(0, 1).forEach(function (slide, index) {
    return slider.blicky.appendChild(infiniteSlide('right', index, slide));
  });
}
...
/*#__PURE__*/
function () {
  function Drag(blicky) {
    (0, _classCallCheck2.default)(this, Drag);
    this.blicky = blicky;
    var slider = this.blicky.slider;
    slider.posX = 0;
  ...
  (0, _createClass2.default)(Drag, [{
    ...
    value: function events() {
      ...
      function mousemove(e) {
        ...
        _move.move.call(blicky, cX);

        blicky.slider.oldcX = cX;
      }

      function mouseup() {
        _snap.snap.call(blicky);
...
var _getDirection = __webpack_require__(119);
...
function snap() {
  var slider = this.slider;
  var percentChange = Math.round((Math.abs(slider.posX) - slider.currentSlide * slider.width) / slider.width * 100);

  var direction = _getDirection.getDirection.call(this);

  slider.oldcX = undefined;

  _transition.transition.call(this);
...
function infiniteReset() {
  ...
  if (currentSlide == 0 && this.slider.posX == 0) {
    var clonesLength = this.slider.blicky.getElementsByClassName('blicky-cloned').length;
    var lastSlide = this.slider.slideCount - 1 + clonesLength / 2;
    this.slider.currentSlide = lastSlide;
    this.slider.posX = lastSlide * this.slider.width * -1;
    this.slider.blicky.style.left = "".concat(this.slider.posX, "px");
  }
}
...
function transition() {
  ...
  var transitionDuration = window.parseFloat(window.getComputedStyle(slider.blicky).getPropertyValue('transition-duration'), 10);
...
function getDirection() {
  var slider = this.slider;
  var lefts = slider.directionalHistory.filter(function (direction) {
    return direction == 'left';
  }).length;
  var rights = slider.directionalHistory.filter(function (direction) {
  ...
  (0, _createClass2.default)(Events, [{
    ...
    value: function resize() {
      ...
      window.addEventListener('resize', function (e) {
        var event = new CustomEvent('blicky.resize', e);
        window.dispatchEvent(event);
      });
      window.addEventListener('blicky.resize', function (e) {
        _build.rebuild.call(self.blicky);
      });
    }
  }]);
  return Events;
...
//# sourceMappingURL=blicky.js.map